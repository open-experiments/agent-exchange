#!/usr/bin/env python3
"""LegalPay Payment Agent - Main entry point."""
...
from agent import LegalPayAgent
...
async def main():
    """Start the LegalPay payment agent server."""
    # Load configuration
    ...
    # Create agent
    agent = LegalPayAgent(config=config)
    ...
    logger.info(f"Payment provider ready - consistent 1% net fee on all legal work")
