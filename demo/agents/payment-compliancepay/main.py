#!/usr/bin/env python3
"""CompliancePay Payment Agent - Main entry point."""
...
from agent import CompliancePayAgent
...
async def main():
    """Start the CompliancePay payment agent server."""
    # Load configuration
    ...
    # Create agent
    agent = CompliancePayAgent(config=config)
    ...
    logger.info(f"Payment provider ready - GET CASHBACK on compliance work with ADVANCED fraud protection!")
